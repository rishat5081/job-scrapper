...
SOURCE_DEFINITIONS = [
    ...
    SourceDefinition(
        ...
        ingestion_mode="official_partner_or_manual",
        enabled_by_default=False,
        automation_allowed=False,
        notes="Listed for visibility, but disabled until an approved partner feed or user-mediated workflow is supplied.",
        tags=["enterprise", "manual-review"],
    ),
    SourceDefinition(
        key="indeed",
        name="Indeed",
        ...
        enabled_by_default=False,
        automation_allowed=False,
        notes="Listed in the catalog, but not automated in this repo without an approved integration.",
        tags=["enterprise", "manual-review"],
    ),
    SourceDefinition(
        key="glassdoor",
        ...
        enabled_by_default=False,
        automation_allowed=False,
        notes="Kept visible in the registry and dashboard. Automation stays disabled by default.",
        tags=["enterprise", "manual-review"],
    ),
    SourceDefinition(
        key="wellfound",
